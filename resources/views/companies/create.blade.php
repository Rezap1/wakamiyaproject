...
<div class="max-w-5xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100 bg-white">
            <h2 class="text-xl font-extrabold text-gray-900">Formulir Pendaftaran Perusahaan</h2>
            <p class="text-sm font-medium text-gray-500 mt-1">Lengkapi data identitas, legalitas, kontak, dan aset visual perusahaan.</p>
        </div>
        ...
        <div class="p-6 md:p-8">
            <form action="{{ route('companies.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="Company_Code" id="Company_Code" value="{{ old('Company_Code') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors font-mono uppercase @error('Company_Code') border-red-300 text-red-900 @enderror" placeholder="Contoh: CMP001">
                        ...
                        <div>
                            ...
                            <input type="text" name="Legal_Name" id="Legal_Name" value="{{ old('Legal_Name') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors @error('Legal_Name') border-red-300 text-red-900 @enderror" placeholder="Contoh: PT. Wakamiya Sejahtera">
                        ...
                        <div>
                            ...
                            <input type="text" name="Company_Name" id="Company_Name" value="{{ old('Company_Name') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors @error('Company_Name') border-red-300 text-red-900 @enderror" placeholder="Contoh: Wakamiya Corp">
                        ...
                        <div>
                            ...
                            <input type="text" name="NPWP" id="NPWP" value="{{ old('NPWP') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors font-mono @error('NPWP') border-red-300 text-red-900 @enderror" placeholder="00.000.000.0-000.000">
                        ...
                        <div>
                            ...
                            <input type="text" name="Business_License_Number" id="Business_License_Number" value="{{ old('Business_License_Number') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors font-mono" placeholder="Nomor Induk Berusaha">
                        </div>

                        <!-- Director -->
                        <div>
                            <label for="Director_Name" class="block text-sm font-bold text-gray-700">Nama Direktur / Pimpinan</label>
                            <input type="text" name="Director_Name" id="Director_Name" value="{{ old('Director_Name') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" placeholder="Nama lengkap pimpinan">
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="Address" name="Address" rows="3" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" placeholder="Jalan, Gedung, Nomor">{{ old('Address') }}</textarea>
                        </div>
                        
                        <!-- City & Province -->
                        <div>
                            <label for="City" class="block text-sm font-bold text-gray-700">Kota / Kabupaten</label>
                            <input type="text" name="City" id="City" value="{{ old('City') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors">
                        </div>
                        <div>
                            <label for="Province" class="block text-sm font-bold text-gray-700">Provinsi / State</label>
                            <input type="text" name="Province" id="Province" value="{{ old('Province') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors">
                        </div>

                        <!-- Postal Code & Country -->
                        <div>
                            <label for="Postal_Code" class="block text-sm font-bold text-gray-700">Kode Pos</label>
                            <input type="text" name="Postal_Code" id="Postal_Code" value="{{ old('Postal_Code') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors font-mono">
                        </div>
                        <div>
                            <label for="Country" class="block text-sm font-bold text-gray-700">Negara <span class="text-red-500">*</span></label>
                            <input type="text" name="Country" id="Country" value="{{ old('Country', 'Indonesia') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors @error('Country') border-red-300 text-red-900 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="Phone_Number" id="Phone_Number" value="{{ old('Phone_Number') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors font-mono" placeholder="021-XXXXXXX">
                        </div>
                        <div>
                            <label for="Email" class="block text-sm font-bold text-gray-700">Alamat Email</label>
                            <input type="email" name="Email" id="Email" value="{{ old('Email') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors @error('Email') border-red-300 text-red-900 @enderror" placeholder="contact@company.com">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="url" name="Website" id="Website" value="{{ old('Website') }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors @error('Website') border-red-300 text-red-900 @enderror" placeholder="https://www.company.com">
                ...
                <div>
                    <h3 class="text-base font-bold text-gray-900 border-b border-gray-200 pb-2 mb-4">3. Aset Visual</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-4">
                                <div id="logo-preview-container" class="h-20 w-20 rounded-xl bg-gray-50 border-2 border-dashed border-gray-300 flex items-center justify-center overflow-hidden flex-shrink-0">
                                ...
                                <div class="flex-grow">
                                    ...
                                    <p class="mt-1.5 text-xs text-gray-500">Maks. 2MB (JPG, PNG, SVG)</p>
                        ...
                        <!-- Stamp Upload -->
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Stempel / Cap</label>
                            <div class="flex items-center gap-4">
                                <div id="stamp-preview-container" class="h-20 w-20 rounded-xl bg-gray-50 border-2 border-dashed border-gray-300 flex items-center justify-center overflow-hidden flex-shrink-0">
                ...
                <!-- Notes -->
                <div>
                    <label for="Notes" class="block text-sm font-bold text-gray-700">Catatan Internal <span class="text-gray-400 font-normal">(Opsional)</span></label>
                ...
                <div class="pt-6 border-t border-gray-100 flex justify-end gap-3">
                    ...
                    <button type="submit" id="submitBtn" class="px-6 py-3 border border-transparent shadow-lg text-sm font-bold rounded-xl text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all hover:-translate-y-0.5 hover:shadow-primary-500/30 flex items-center justify-center gap-2">
                        <span id="submitText">Simpan Perusahaan</span>

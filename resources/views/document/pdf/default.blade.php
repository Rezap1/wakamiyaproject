<div class="my-8">
    ...
    <div class="text-sm text-slate-700 leading-relaxed space-y-4">
        {{ $document['Message'] ?? 'Dokumen ini dibuat otomatis oleh sistem dokumen WMS dengan tata letak standar.' }}
    </div>
    ...
    <table class="w-full text-left text-xs mt-8 border-collapse">
        <tbody>
            ...
            <tr>
                ...
                <td class="py-2 border-b border-slate-200">{{ \App\Support\Presentation\IndonesianPresentation::status($document['Status'] ?? null) }}</td>
            </tr>
        </tbody>
    </table>
</div>

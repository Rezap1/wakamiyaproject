    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 overflow-hidden">
        <div class="p-6 md:p-8 border-b border-gray-100 dark:border-slate-800">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-2xl font-extrabold text-gray-900 dark:text-white">Buat Modul</h2>
                    <p class="text-sm font-medium text-gray-500 dark:text-slate-400 mt-1">Lengkapi formulir di bawah ini untuk menambahkan modul aplikasi baru.</p>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('modules.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="Module_Name" id="Module_Name" value="{{ old('Module_Name') }}" class="block w-full rounded-xl border-gray-300 dark:border-slate-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 dark:bg-slate-800 focus:bg-white dark:bg-slate-900 transition-colors" required placeholder="Contoh: User Management">
                    ...
                    <div>
                        ...
                        <input type="text" name="Module_Group" id="Module_Group" value="{{ old('Module_Group') }}" class="block w-full rounded-xl border-gray-300 dark:border-slate-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 dark:bg-slate-800 focus:bg-white dark:bg-slate-900 transition-colors" required placeholder="Contoh: Settings">
                    ...
                    <div>
                        ...
                        <input type="number" name="Module_Order" id="Module_Order" value="{{ old('Module_Order', '1') }}" class="block w-full rounded-xl border-gray-300 dark:border-slate-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 dark:bg-slate-800 focus:bg-white dark:bg-slate-900 transition-colors" required min="0">

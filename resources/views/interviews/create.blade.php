...
@section('header', 'Tambah Jadwal Interview')
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 md:p-8 border-b border-gray-100">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-2xl font-extrabold text-gray-900">Buat Jadwal Interview</h2>
                    <p class="text-sm font-medium text-gray-500 mt-1">Isi formulir di bawah ini untuk menjadwalkan interview baru.</p>
                </div>
            </div>
        </div>

        <div class="p-6 md:p-8">
            <form action="{{ route('interviews.store') }}" method="POST" class="space-y-10">
                @csrf
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="Interview_Number" id="Interview_Number" value="{{ old('Interview_Number') }}" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" placeholder="Cth: INV-2023-001">
                        ...
                        <div>
                            ...
                            <input type="date" name="Interview_Date" id="Interview_Date" value="{{ old('Interview_Date') }}" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" required>
                        ...
                        <div>
                            ...
                            <input type="time" name="Interview_Time" id="Interview_Time" value="{{ old('Interview_Time') }}" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" required>
                        ...
                        <div>
                            ...
                            <select name="Interview_Method" id="Interview_Method" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" required>
                                ...
                                <option value="Online (Zoom/Meet)" {{ old('Interview_Method') == 'Online (Zoom/Meet)' ? 'selected' : '' }}>Online (Zoom/Meet)</option>
                                <option value="Offline (Tatap Muka)" {{ old('Interview_Method') == 'Offline (Tatap Muka)' ? 'selected' : '' }}>Offline (Tatap Muka)</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="Interviewer" id="Interviewer" value="{{ old('Interviewer') }}" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" placeholder="Perwakilan perusahaan">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="Interview_Status" id="Interview_Status" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" required>
                                <option value="SCHEDULED" {{ old('Interview_Status') == 'SCHEDULED' ? 'selected' : '' }}>Scheduled (Dijadwalkan)</option>
                                <option value="COMPLETED" {{ old('Interview_Status') == 'COMPLETED' ? 'selected' : '' }}>Completed (Selesai)</option>
                                <option value="CANCELLED" {{ old('Interview_Status') == 'CANCELLED' ? 'selected' : '' }}>Cancelled (Dibatalkan)</option>
                                <option value="RESCHEDULED" {{ old('Interview_Status') == 'RESCHEDULED' ? 'selected' : '' }}>Rescheduled (Dijadwalkan Ulang)</option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="Interview_Result" id="Interview_Result" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" required>
                                <option value="PENDING" {{ old('Interview_Result') == 'PENDING' ? 'selected' : '' }}>PENDING (Menunggu Keputusan)</option>
                                <option value="PASSED" {{ old('Interview_Result') == 'PASSED' ? 'selected' : '' }}>PASSED (Lulus)</option>
                                <option value="FAILED" {{ old('Interview_Result') == 'FAILED' ? 'selected' : '' }}>FAILED (Gagal)</option>
                                <option value="RESERVE" {{ old('Interview_Result') == 'RESERVE' ? 'selected' : '' }}>RESERVE (Cadangan)</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" name="Result_Date" id="Result_Date" value="{{ old('Result_Date') }}" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors">
                        </div>

...
<div class="max-w-5xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100 bg-white">
            <h2 class="text-xl font-extrabold text-gray-900">Formulir Pendaftaran Tenaga Pendidik</h2>
            <p class="text-sm font-medium text-gray-500 mt-1">Pilih Karyawan yang telah terdaftar untuk diangkat sebagai Guru. Kode Guru (TCH) akan dibuat otomatis.</p>
        </div>
            ...
            <form action="{{ route('teachers.store') }}" method="POST" class="space-y-10">
                ...
                <div>
                    ...
                    <div class="mb-6 bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-3">
                        ...
                        <p class="text-sm text-blue-800">Seorang pengajar wajib tercatat sebagai Karyawan terlebih dahulu di sistem. Dropdown di bawah ini hanya memunculkan karyawan aktif yang belum terdaftar sebagai Tenaga Pendidik.</p>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            <label for="Employee_ID" class="block text-sm font-bold text-gray-700">Pilih Data Karyawan <span class="text-red-500">*</span></label>
                            <select name="Employee_ID" id="Employee_ID" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors @error('Employee_ID') border-red-300 text-red-900 @enderror">
                                <option value="" disabled selected>-- Cari dan Pilih Karyawan --</option>
                ...
                <div>
                    <h3 class="text-base font-bold text-gray-900 border-b border-gray-200 pb-2 mb-6 flex items-center">
                        ...
                        Informasi Karyawan Terpilih (Read-Only)
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Full Name -->
                        <div class="md:col-span-2">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="Hire_Date" id="Hire_Date" value="{{ old('Hire_Date', date('Y-m-d')) }}" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors @error('Hire_Date') border-red-300 text-red-900 @enderror">
                        ...
                        <div>
                            ...
                            <select name="Teaching_Status" id="Teaching_Status" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors @error('Teaching_Status') border-red-300 text-red-900 @enderror">
                                ...
                                <option value="Aktif Mengajar" {{ old('Teaching_Status') == 'Aktif Mengajar' ? 'selected' : '' }}>Aktif Mengajar</option>
                                <option value="Cuti Mengajar" {{ old('Teaching_Status') == 'Cuti Mengajar' ? 'selected' : '' }}>Cuti Mengajar</option>
                            </select>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="Notes" name="Notes" rows="3" class="mt-2 block w-full rounded-xl border-gray-300 focus:ring-primary-500 focus:border-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" placeholder="Informasi tambahan terkait pengajaran...">{{ old('Notes') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="pt-6 border-t border-gray-100 flex justify-end gap-3 sticky bottom-0 bg-white/80 backdrop-blur-md pb-4 rounded-b-2xl">
                    ...
                    <button type="submit" id="submitBtn" class="px-6 py-3 border border-transparent shadow-lg text-sm font-bold rounded-xl text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all hover:-translate-y-0.5 hover:shadow-primary-500/30 flex items-center justify-center gap-2">
                        <span id="submitText">Simpan Guru Baru</span>

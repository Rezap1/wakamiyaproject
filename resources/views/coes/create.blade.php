...
<div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 md:p-8 border-b border-gray-100 flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-extrabold text-gray-900">Tambah Data COE Baru</h2>
                <p class="text-sm font-medium text-gray-500 mt-1">Buat pengajuan Certificate of Eligibility untuk kandidat yang terpilih.</p>
            </div>
        </div>

        <div class="p-6 md:p-8">
            <form action="{{ route('coes.store') }}" method="POST" class="space-y-10">
                @csrf
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="COE_Number" id="COE_Number" value="{{ old('COE_Number') }}" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" placeholder="Contoh: COE-2023-001" required>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div>
                            ...
                            <input type="date" name="Application_Date" id="Application_Date" value="{{ old('Application_Date') }}" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors">
                        ...
                        <div>
                            ...
                            <input type="date" name="COE_Expiry_Date" id="COE_Expiry_Date" value="{{ old('COE_Expiry_Date') }}" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="COE_Status" id="COE_Status" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" required>
                                <option value="PREPARING" {{ old('COE_Status') == 'PREPARING' ? 'selected' : '' }}>PREPARING (Persiapan Berkas)</option>
                                <option value="SUBMITTED" {{ old('COE_Status') == 'SUBMITTED' ? 'selected' : '' }}>SUBMITTED (Diajukan ke Imigrasi)</option>
                                <option value="APPROVED" {{ old('COE_Status') == 'APPROVED' ? 'selected' : '' }}>APPROVED (Disetujui)</option>
                                <option value="REJECTED" {{ old('COE_Status') == 'REJECTED' ? 'selected' : '' }}>REJECTED (Ditolak)</option>
                            </select>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="Immigration_Office" id="Immigration_Office" value="{{ old('Immigration_Office') }}" class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm px-4 py-3 bg-gray-50 focus:bg-white transition-colors" placeholder="Contoh: Tokyo Regional Immigration Bureau">
                ...
                <div class="pt-6 border-t border-gray-100 flex justify-end gap-3 sticky bottom-0 bg-white p-4 shadow-[0_-10px_15px_-3px_rgba(0,0,0,0.05)] border-t">
                    ...
                    <button type="submit" id="submitBtn" class="px-6 py-3 border border-transparent shadow-lg text-sm font-bold rounded-xl text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all hover:-translate-y-0.5 hover:shadow-primary-500/30 flex items-center justify-center gap-2">
                        <span id="submitText">Simpan Data COE</span>

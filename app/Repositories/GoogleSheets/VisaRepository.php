...
class VisaRepository extends BaseSheetRepository implements VisaRepositoryInterface
{
    public function __construct()
    {
        parent::__construct();
        $this->sheetName = 'VISA';
        $this->primaryKey = 'Visa_ID';
        $this->cacheKey = 'visas_sheet';
    }
    ...
    {
        $visas = parent::fetchAll();
        return $visas->firstWhere($this->primaryKey, $id);
    }
    ...
    /**
     * Generate new ID for VISA (Format: VIS000001)
     * @return string
     */

...
class AdminDashboardService
{
    ...
    {
        return Cache::remember('dashboard_admin', 300, function () {
            // === Fetch all data ONCE ===
            ...
            try {
                ...
                $pendapatan = $allTransactions->where('Type', 'Income')->sum('Amount');
                $pengeluaran = $allTransactions->where('Type', 'Expense')->sum('Amount');
                ...
                $thisRevenue = $thisMonthTxns->where('Type', 'Income')->sum('Amount');
                $lastRevenue = $lastMonthTxns->where('Type', 'Income')->sum('Amount');
                $thisExpense = $thisMonthTxns->where('Type', 'Expense')->sum('Amount');
                $lastExpense = $lastMonthTxns->where('Type', 'Expense')->sum('Amount');

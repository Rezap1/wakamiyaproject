...
@php
    ...
    if ($role === 'STUDENT') {
        $items = [
            ...
            ['label' => 'Scan QR', 'route' => 'attendances.student.scanner', 'icon' => 'barcode-scan', 'active' => request()->routeIs('attendances.student.*')],
...
file_put_contents('resources/views/components/mobile-bottom-nav.blade.php', $content);
echo "Written mobile bottom nav.";
?>
